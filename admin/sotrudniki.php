...
$result_user = mysqli_query($connect, query: "SELECT user.*, img.File FROM user INNER JOIN img ON user.Image = img.id");
            ...
            <div class="sotrudnik_card">
                ...
                ?>
                    <div class="card-container">
                        <img class="round" src="<?= $sotrudnik['File'] ?>" alt="user">
        ...
        <div class="container_create_user">
            ...
            <div class="content_create_user">
                <form action="../config/create_user.php" method="post" enctype="multipart/form-data">
                    ...
                    <label for="city-select">Должность</label>
                    <select name="Post" id="city-select">
